...
function constructUnfixableText(unresolved, basicVulnInfo, testOptions) {
    ...
    for (const issue of unresolved) {
        ...
        unfixableIssuesTextArray.push(formatIssue(issue.id, issue.title, issue.severity, issue.isNew, undefined, `${issue.packageName}@${issue.version}`, issueInfo.paths, testOptions) + `${extraInfo}`);
    }
